...
abstract class AbstractScopedCallback implements ScopedCallbackInterface
{
    ...
    public function visit(NodeTraversal $traversal, \PHPParser_Node $node, \PHPParser_Node $parent = null) { }
    public function enterScope(NodeTraversal $traversal) { }
    public function exitScope(NodeTraversal $traversal) { }
}