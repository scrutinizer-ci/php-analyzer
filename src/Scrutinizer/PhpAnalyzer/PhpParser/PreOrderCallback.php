...
/**
 * A simple wrapper to allow traversal using a simple callable.
 *
 * @author Johannes M. Schmitt <johannes@scrutinizer-ci.com>
 */
class PreOrderCallback implements \Scrutinizer\PhpAnalyzer\PhpParser\Traversal\CallbackInterface
{
    private $callable;
    ...
    {
        if (false === call_user_func($this->callable, $t, $node, $parent)) {
            return false;
        }
