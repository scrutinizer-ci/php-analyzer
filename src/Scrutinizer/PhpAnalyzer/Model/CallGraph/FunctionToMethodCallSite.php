 ...
 * @author Johannes
 */
class FunctionToMethodCallSite extends CallSite
{
    /** @ORM\ManyToOne(targetEntity = "Scrutinizer\PhpAnalyzer\Model\GlobalFunction", inversedBy = "outMethodCallSites") */
    private $sourceFunction;

    /** @ORM\ManyToOne(targetEntity = "Scrutinizer\PhpAnalyzer\Model\Method", inversedBy = "inFunctionCallSites") */
