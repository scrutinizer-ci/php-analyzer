 ...
 * @author Johannes
 */
class FunctionToFunctionCallSite extends CallSite
{
    /** @ORM\ManyToOne(targetEntity = "Scrutinizer\PhpAnalyzer\Model\GlobalFunction", inversedBy = "outFunctionCallSites") */
    private $sourceFunction;

    /** @ORM\ManyToOne(targetEntity = "Scrutinizer\PhpAnalyzer\Model\GlobalFunction", inversedBy = "inFunctionCallSites") */
