 ...
 * @author Johannes
 */
class MethodToMethodCallSite extends CallSite
{
    /** @ORM\ManyToOne(targetEntity = "Scrutinizer\PhpAnalyzer\Model\Method", inversedBy = "outMethodCallSites") */
    private $sourceMethod;

    /** @ORM\ManyToOne(targetEntity = "Scrutinizer\PhpAnalyzer\Model\Method", inversedBy = "inMethodCallSites") */
