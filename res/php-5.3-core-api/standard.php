 ...
 *
 * @jms-builtin
 * @jms-variable-parameters This could be removed if we support different parameter sets.
 */
...
function sprintf ($format, $args = null, $_ = null) {
	// We add this function call here as this is considered by the parser
 ...
 * @jms-builtin
 */
function array_merge (array $array1, array $array2 = array(), array $_ = array()) {}
