 ...
 * The input string.
 * </p>
 * @param array<array<string>> $matches  <p>
 * Normally, the search starts from the beginning of the subject string.
 * The optional parameter offset can be used to
 * specify the alternate place from which to start the search (in bytes).
 * </p>
 ...
 * replacements done.
 * </p>
 * @return array<string>|string preg_replace returns an array if the
 ...
 * replacements done.
 * </p>
 * @return string|array<string> preg_replace_callback returns an array if the
 * subject parameter is an array, or a string
 ...
 * @return string|array<string> an array if the subject
