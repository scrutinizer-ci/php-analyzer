 ...
 * The input string.
 * </p>
 * @param array<string> $matches [optional] <p>
 ...
 * The input string.
 * </p>
 * @param array<array<string>> $matches [optional] <p>
 * Normally, the search starts from the beginning of the subject string.
 * The optional parameter <i>offset</i> can be used to
 * specify the alternate place from which to start the search (in bytes).
 * </p>
 ...
 * @param string|array<string> $pattern <p>
 ...
 * replacements done.
 * </p>
 * @return string|array<string> <b>preg_replace</b> returns an array if the
 ...
 * replacements done.
 * </p>
 * @return string|array<string> <b>preg_replace_callback</b> returns an array if the
 * <i>subject</i> parameter is an array, or a string
 ...
 * @return string|array<string> an array if the <i>subject</i>
 ...
 * </p>
 * @return array<string> an array indexed using the keys from the
 * <i>input</i> array.
 * @jms-builtin
 */
