...
class ReflectionFunctionAbstract implements Reflector {
	 ...
	 * @return array<ReflectionParameter> The parameters, as a <b>ReflectionParameter</b> object.
	 */
...
class ReflectionClass implements Reflector {
	 ...
	 * </p>
	 * @return array<ReflectionProperty> An array of <b>ReflectionProperty</b> objects.
	 */
	 ...
	 * @return array<string,ReflectionClass> an array with trait names in keys and instances of trait's
	 ...
	 * @return array<string> an array with trait names in values.
	 * Returns <b>NULL</b> in case of an error.
	 */
	 ...
	 * @return array<string,string> an array with new method names in keys and original names (in the
	 ...
	 * @return array<string,null|scalar|array> An array of default properties, with the key being the name of
...
class ReflectionObject extends ReflectionClass implements Reflector {
	 ...
	 * Gets static properties
	 * @link http://php.net/manual/en/reflectionclass.getstaticproperties.php
	 * @return array<string,null|scalar|array> The static properties, as an array.
	 */
	public function getStaticProperties () {}
...
class ReflectionExtension implements Reflector {
	 ...
	 * @return array<string,ReflectionFunction> An associative array of <b>ReflectionFunction</b> objects,
	 ...
	 * @return array<ReflectionClass> An array of <b>ReflectionClass</b> objects, one
