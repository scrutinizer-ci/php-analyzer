 ...
 * @jms-builtin
 */
function sqlite_popen ($filename, $mode = 0666, &$error_message = null) {}
 ...
 * @jms-builtin
 */
function sqlite_query ($query, $result_type = 'SQLITE_BOTH', &$error_msg = null) {}
 ...
 * @jms-builtin
 */
function sqlite_array_query ($query, $result_type = 'SQLITE_BOTH', $decode_binary = true) {}
 ...
 * @jms-builtin
 */
function sqlite_fetch_array ($result_type = 'SQLITE_BOTH', $decode_binary = true) {}
 ...
 * @jms-builtin
 */
function sqlite_fetch_object ($class_name = null, array $ctor_params = null, $decode_binary = true) {}
 ...
 * @jms-builtin
 */
function sqlite_fetch_all ($result_type = 'SQLITE_BOTH', $decode_binary = true) {}
 ...
 * @jms-builtin
 */
function sqlite_current ($result_type = 'SQLITE_BOTH', $decode_binary = true) {}
 ...
 * @jms-builtin
 */
function sqlite_unbuffered_query ($query, $result_type = 'SQLITE_BOTH', &$error_msg = null) {}
 ...
 * @jms-builtin
 */
function sqlite_factory ($filename, $mode = 0666, &$error_message = null) {}
 ...
 * @jms-builtin
 */
function sqlite_fetch_column_types ($table_name, $result_type = 'SQLITE_ASSOC') {}
