...
class DeadAssignmentsDetectionPassTest extends BaseReviewingPassTest
{
    protected function getPasses()
    {
        return array(new DeadAssignmentsDetectionPass());
    }

    protected function getTestDir()
    {
        return __DIR__.'/Fixture/DeadAssignment/';
    }
}