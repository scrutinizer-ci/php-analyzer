...
class UseStatementFixingPassTest extends BaseFixingPassTest
{
    protected function getTestDir()
    {
        return __DIR__.'/Fixture/UseStatementFixes/';
    }

    protected function getPasses()
    {
        $passes = PassConfig::createForTypeScanning()->getPasses();
        $passes[] = new \Scrutinizer\PhpAnalyzer\Pass\UseStatementFixerPass();
